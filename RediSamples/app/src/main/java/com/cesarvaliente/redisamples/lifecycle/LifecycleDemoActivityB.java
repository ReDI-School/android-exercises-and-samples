...
public class LifecycleDemoActivityB extends Activity {
    ...
    private void bindViews() {
        ...
        textView.setText(R.string.lifecycle_text_activity_b);
        changeActivityBtn.setText(R.string.lifecycle_to_activity_a);
        changeActivityBtn.setBackgroundColor(getResources().getColor(android.R.color.holo_blue_light));
